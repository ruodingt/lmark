...
if __name__ == "__main__":
    ...
    # conf_root = "/home/appuser/detectron2/pearlii-detection/configs/exp"
    # # _d_c = "cascade_normal_R50_C3[D,C,W]S1[C]_exp_13.yaml"
    # args.config_file = os.path.join(conf_root, args.config_file)
